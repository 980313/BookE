  ...
  <div class="ebook-slide-contents">
    ...
    <div class="slide-contents-book-wrapper" v-show="!searchVisible">
      ...
      <div class="slide-contents-book-info-wrapper">
        <div class="slider-content-book-title">
    ...
    <scroll class="slide-contents-list" :top="156" :bottom="48" v-show="!searchVisible" ref="scroll">
...
import { px2rem } from "../../util/utils.js";
...
export default {
  ...
  methods: {
    ...
    displayContent(target, hightlight = false){
      ...
      if(hightlight){
        this.currentBook.rendition.annotations.hightlight(target)
      }
    },
    showSearchPage(){
